...
public class FeedBackFragment extends BaseDrawerFragment implements OnClickListener, IXListViewListener {
    ...
    private void initHeader() {
        View var1 = LayoutInflater.from(this.mActivity).inflate(R.layout.fragment_feedback_item_header, (ViewGroup) null);
    ...
    public void initViews(View var1) {
        ...
        ((TextView) var1.findViewById(R.id.title)).setText("问题反馈");
        this.lv_feedback = (XListView) var1.findViewById(R.id.lv_feedback);
