...
public class ModifyPwActivity extends Activity implements OnClickListener {
    ...
    private void initViews() {
        this.btnBack = (ImageView) this.findViewById(R.id.back_btn);
        this.btnBack.setImageResource(R.drawable.back);
        this.tv_title = (TextView) this.findViewById(R.id.title);
        this.tv_title.setText("修改密码");
        this.et_old_pwd = (EditText) this.findViewById(R.id.et_old_pwd);
        this.et_new_pwd = (EditText) this.findViewById(R.id.et_new_pwd);
        this.et_confirm_pwd = (EditText) this.findViewById(R.id.et_confirm_pwd);
        this.submitBtn = (TextView) this.findViewById(R.id.btn_submit);
        this.submitBtn.setBackgroundResource(R.drawable.sdk_dialog_login_button_bg);
    ...
    protected void onCreate(Bundle var1) {
        super.onCreate(var1);
        this.setContentView(R.layout.activity_modifypw);
        this.initViews();
        this.initEvents();
    }
}
