...
import com.kding.PayConfirmFragment;
...
public class PayCenterFragment extends BaseDialogFragment {
  ...
  private void enableAliandUnionPay() {
    ...
    this.alipayImageView.setImageResource(2130837527);
    this.unionImageView.setImageResource(2130837534);
  }
  ...
  private void switchPayBtnBackground() {
    switch(this.payType) {
      case 0:
        this.aliPayBtn.setBackgroundResource(2130837546);
        this.unionPayBtn.setBackgroundResource(2130837545);
        this.qxzPayBtn.setBackgroundResource(2130837545);
        this.setConfirmBtnText();
        return;
      case 1:
        this.aliPayBtn.setBackgroundResource(2130837545);
        this.unionPayBtn.setBackgroundResource(2130837546);
        this.qxzPayBtn.setBackgroundResource(2130837545);
        this.setConfirmBtnText();
        return;
      case 2:
        this.aliPayBtn.setBackgroundResource(2130837545);
        this.unionPayBtn.setBackgroundResource(2130837545);
        this.qxzPayBtn.setBackgroundResource(2130837546);
        int var1 = (int)Math.ceil((double)(Float.valueOf(this.realPay).floatValue() * 10.0F));
  ...
  public void disableAliandUnionPay() {
    ...
    this.alipayImageView.setImageResource(2130837528);
    this.unionImageView.setImageResource(2130837535);
  }
  ...
  public void initViews(View var1) {
    this.closeBtn = (ImageView)var1.findViewById(2131230812);
    this.orderMoneyTextView = (TextView)var1.findViewById(2131230798);
    this.qxzPlatformMoney = (TextView)var1.findViewById(2131230810);
    this.platformMoneyTextView = (TextView)var1.findViewById(2131230809);
    this.deductionTextView = (TextView)var1.findViewById(2131230802);
    this.progressBar = (ProgressBar)var1.findViewById(2131230765);
    this.aliPayBtn = var1.findViewById(2131230804);
    this.unionPayBtn = var1.findViewById(2131230806);
    this.qxzPayBtn = var1.findViewById(2131230808);
    this.alipayImageView = (ImageView)var1.findViewById(2131230805);
    this.unionImageView = (ImageView)var1.findViewById(2131230807);
    this.confirmPayBtn = (Button)var1.findViewById(2131230811);
    this.couponsSpanner = (Spinner)var1.findViewById(2131230800);
    this.adapter = new ArrayAdapter(this.mActivity, 2130903073, this.couponsTextList);
    this.adapter.setDropDownViewResource(2130903072);
  ...
  public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
    View var4 = var1.inflate(2130903066, var2, false);
    this.initViews(var4);
    this.initEvents();
    this.updateView();
