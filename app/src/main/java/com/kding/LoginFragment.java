...
public class LoginFragment extends BaseDialogFragment implements OnClickListener {
  ...
  private void initViews(View var1) {
    ...
    this.sdk_dialog_login_title = (TextView)var1.findViewById(2131230837);
    this.sdk_dialog_login_phone_name = (EditText)var1.findViewById(2131230838);
    this.sdk_dialog_login_clear = (ImageView)var1.findViewById(2131230839);
    this.sdk_dialog_login_sms_pwd = (EditText)var1.findViewById(2131230840);
    this.sdk_dialog_login_sendvcode = (TextView)var1.findViewById(2131230841);
    this.sdk_dialog_login_button = (Button)var1.findViewById(2131230842);
    this.sdk_dialog_login_switcher = (TextView)var1.findViewById(2131230843);
  ...
  public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
    ...
    View var4 = var1.inflate(2130903077, var2);
    this.initViews(var4);
    this.initEvents();
  ...
  public void switchLoginMode() {
    ...
    switch(this.mLoginType) {
      case 1:
        this.sdk_dialog_login_title.setText(this.getString(2131099661));
        this.sdk_dialog_login_phone_name.setHint(2131099660);
        this.sdk_dialog_login_phone_name.setInputType(3);
        this.sdk_dialog_login_sms_pwd.setHint(2131099658);
        this.sdk_dialog_login_sms_pwd.setInputType(2);
        this.sdk_dialog_login_switcher.setText(this.getString(2131099662));
        this.sdk_dialog_login_sendvcode.setVisibility(0);
        this.sdk_dialog_login_phone_name.setText(this.mLoginPhone);
        return;
      case 2:
        this.sdk_dialog_login_title.setText(this.getString(2131099662));
        this.sdk_dialog_login_phone_name.setHint(2131099655);
        this.sdk_dialog_login_phone_name.setInputType(1);
        this.sdk_dialog_login_sms_pwd.setHint(2131099659);
        this.sdk_dialog_login_sms_pwd.setInputType(129);
        this.sdk_dialog_login_switcher.setText(this.getString(2131099656));
