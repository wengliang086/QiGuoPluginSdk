...
public class XFooterView extends LinearLayout {
  ...
  private void initView(Context var1) {
    this.mLayout = LayoutInflater.from(var1).inflate(2130903074, (ViewGroup)null);
    this.mLayout.setLayoutParams(new LayoutParams(-1, -2));
    this.addView(this.mLayout);
    this.mProgressBar = this.mLayout.findViewById(2131230821);
    this.mHintView = (TextView)this.mLayout.findViewById(2131230822);
