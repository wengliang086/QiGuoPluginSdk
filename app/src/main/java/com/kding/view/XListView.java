...
import com.kding.view.XFooterView;
import com.kding.view.XHeaderView;
...
public class XListView extends ListView implements OnScrollListener {
  ...
  private void initWithContext(Context var1) {
    ...
    this.mHeaderContent = (RelativeLayout)this.mHeader.findViewById(2131230824);
    this.mHeaderTime = (TextView)this.mHeader.findViewById(2131230827);
