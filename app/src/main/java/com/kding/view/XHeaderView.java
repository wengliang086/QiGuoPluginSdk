...
public class XHeaderView extends LinearLayout {
    ...
    private void initView(Context var1) {
        ...
        this.mContainer = (LinearLayout) LayoutInflater.from(var1).inflate(R.layout.qxz_vw_header, (ViewGroup) null);
        this.addView(this.mContainer, var2);
        this.setGravity(80);
        this.mArrowImageView = (ImageView) this.findViewById(R.id.qxz_header_arrow);
        this.mArrowImageView.setImageResource(R.drawable.qxz_arrow_down);
        this.mHintTextView = (TextView) this.findViewById(R.id.qxz_header_hint_text);
        this.mProgressBar = (ProgressBar) this.findViewById(R.id.qxz_header_progressbar);
